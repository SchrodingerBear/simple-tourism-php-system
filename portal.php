...
<header class="masthead">
	<div class="container">
		<div class="masthead-heading text-uppercase">Human Explore Travel and Tours</div>
...
<section class="page-section bg-dark" id="map">
<div class="map-container">
	<div class="map-wrapper">
		<iframe 
			src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3885.3752332864346!2d123.7367578107715!3d13.138714987138783!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33a103d4e4c3d497%3A0x6debc8305bc75204!2sHuman%20Explore%20Travel%20and%20Tours!5e0!3m2!1sen!2sph!4v1723550207534!5m2!1sen!2sph" 	
			width="600" 
			height="450" 
			style="border:0;" 
			allowfullscreen="" 
					...
					<div class="box-width-lg-470">
						...
						<div class="tabs-custom tabs-horizontal tabs-line tabs-line-big tabs-line-style-2 text-center text-md-left" id="tabs-7">
							...
							<ul class="nav nav-tabs">
								<li class="nav-item" role="presentation"><a class="nav-link active" href="#tabs-7-1" data-toggle="tab">Why Us</a></li>
							</ul>
							<!-- Tab panes-->
							<div class="tab-content">
								<div class="tab-pane fade show active" id="tabs-7-1">
									<?php echo file_get_contents(base_app.'about.html') ?>
									<?php echo file_get_contents(base_app.'whyus.html') ?>
										<div class="group-md group-middle"><a class="button button-secondary button-pipaluk" href="about.php">About</a></div>
								</div>
							</div>
						</div>		
