        ...
        <table class="table table-stripped text-dark">
            ...
            <thead>
             ...
             <tbody>
                <?php 
                $i=1;
                $qry = $conn->query("SELECT b.*,p.title,concat(u.firstname,' ',u.lastname) as name FROM book_list b inner join `packages` p on p.id = b.package_id inner join users u on u.id = b.user_id ORDER BY FIELD(b.status, 0, 1, 2, 3) DESC, date(b.date_created) DESC");
                ...
                ?>
                    <tr>
                        ...
                        <td align="center">
                         <button type="button" class="btn btn-flat btn-default btn-sm view_data" data-id="<?php echo $row['id'] ?>"><span class="fas fa-edit text-primary"></span></button>
                        <button type="button" class="btn btn-flat btn-default btn-sm delete_data" data-id="<?php echo $row['id'] ?>"><span class="fas fa-trash text-danger"></span></button>
                        </td>
