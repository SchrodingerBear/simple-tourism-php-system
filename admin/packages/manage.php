...
<div class="card card-outline card-info">
    ...
    <div class="card-body">
        <form action="" id="package-form">
            ...
            <div class="form-group">
                <label for="booking_limit" class="control-label">Booking Limit Per Day</label>
                <input type="number" name="booking_limit" id="booking_limit" class="form-control" value="<?php echo isset($booking_limit) ? $booking_limit : ''; ?>" min="0" required>
            </div>
            <div class="form-group">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#package-form').submit(function(e) {
            ...
            var bookingLimit = $('#booking_limit').val();
            if (bookingLimit < 0) {
                alert_toast("Booking limit must be a positive number.", 'error');
                return;
            }
